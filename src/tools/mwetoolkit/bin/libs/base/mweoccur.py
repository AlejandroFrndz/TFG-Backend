...
class MWEOccurrence(object):
    ...
    @param category A string to represent the category of the MWE occur 
    (as in PARSEME's cupt format specification). 
    ...
    """
    def __init__(self, sentence, candidate, sentence_indexes, category=None):
